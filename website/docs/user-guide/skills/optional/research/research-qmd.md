...
| | |
|---|---|
| Source | Optional — install with `gpucloud skills install official/research/qmd` |
...
GPUCLOUD Agent via the native MCP client. This is the preferred
...
Then configure GPUCLOUD Agent to connect via HTTP:
