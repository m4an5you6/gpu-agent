"""Tests for gpucloud_cli/bundles.py — the `gpucloud bundles` CLI subcommand."""
...
from gpucloud_cli.bundles import (
    bundles_command,
    register_cli,
)
...
def bundles_env(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("GPUCLOUD_BUNDLES_DIR", str(bundles_dir))
