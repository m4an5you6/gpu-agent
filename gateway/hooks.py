...
Hooks are discovered from ~/.gpucloud/hooks/ directories, each containing:
...
Context dict passed to ``agent:start`` / ``agent:end`` handlers:
  ...
  session_id   -- GPUCLOUD session id
...
HOOKS_DIR = get_gpucloud_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"gpucloud_hook_{hook_name}"
