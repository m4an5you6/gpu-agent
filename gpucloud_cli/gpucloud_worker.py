...
from gpucloud_cli.gpucloud_worker_task import WorkerTask, WorkerTaskError, load_worker_task
...
def worker_state_dir() -> Path:
    ...
    path = Path(override).expanduser() if override else get_gpucloud_home() / "gpucloud" / "worker_jobs"
