"""``gpucloud mcp`` subcommand parser.

Extracted from ``gpucloud_cli/main.py:main()`` (god-file Phase 2 follow-up).
...
from gpucloud_cli.subcommands._shared import add_accept_hooks_flag
