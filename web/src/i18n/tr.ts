...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateGPUCLOUD: "GPUCLOUD'i Güncelle",
    updatingGPUCLOUD: "GPUCLOUD güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "GPUCLOUD eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`gpucloud plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.gpucloud/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.gpucloud/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.gpucloud/skills/ adresinden yüklenir",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk GPUCLOUD rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle:
        "GPUCLOUD oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "GPUCLOUD'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. GPUCLOUD ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "GPUCLOUD yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
