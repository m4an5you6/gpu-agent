...
Skins are defined as YAML files in ~/.gpucloud/skins/ or as built-in presets.
...
.. code-block:: python
    ...
    from gpucloud_cli.skin_engine import get_active_skin, list_skins, set_active_skin
    ...
    set_active_skin("mytheme")            # Switch to user skin from ~/.gpucloud/skins/
...
Drop a YAML file in ``~/.gpucloud/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces GPUCLOUD_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces GPUCLOUD_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic GPUCLOUD — gold and kawaii",
        "colors": {
...
def _skins_dir() -> Path:
    ...
    return get_gpucloud_home() / "skins"
