...
_DEP_CHECKS = {
    ...
    "browser": lambda: (
        ...
        or _has_gpucloud_agent_browser()
    ),
...
def _has_gpucloud_agent_browser() -> bool:
    ...
    # install.sh installs globally into $GPUCLOUD_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-GPUCLOUDHome", str(get_gpucloud_home()),
        ]
    else:
