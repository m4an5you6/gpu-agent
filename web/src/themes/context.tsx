...
const STORAGE_KEY = "gpucloud-dashboard-theme";
...
const FONT_STORAGE_KEY = "gpucloud-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `gpucloud_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "gpucloud-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-gpucloud-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-gpucloud-theme-font", "true");
