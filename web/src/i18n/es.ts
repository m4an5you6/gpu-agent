...
export const es: Translations = {
  ...
  status: {
    ...
    stopped: "Detenido",
    updateGPUCLOUD: "Actualizar GPUCLOUD",
    updatingGPUCLOUD: "Actualizando GPUCLOUD…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de GPUCLOUD (equivalente a `gpucloud plugins`).",
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.gpucloud/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.gpucloud/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.gpucloud/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Insignias coleccionables de GPUCLOUD ganadas a partir del historial real de sesiones. Los logros conocidos no completados se muestran como Descubiertos; los logros secretos permanecen ocultos hasta que aparece el primer comportamiento coincidente.",
      scan_subtitle:
        "Escaneando el historial de sesiones de GPUCLOUD. El primer escaneo puede tardar 5–10 segundos en historiales grandes.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Más reciente",
      latest_hint_empty: "usa GPUCLOUD más",
    ...
    guide: {
      ...
      secret_body:
        "Los secretos ocultan su disparador exacto. Una vez que GPUCLOUD detecta una señal relacionada, la tarjeta pasa a Descubierto y muestra su requisito.",
      scan_status_header: "Estado del escaneo",
      scan_status_body:
        "GPUCLOUD está escaneando el historial local una vez, después las tarjetas aparecerán automáticamente. No hay nada bloqueado si tarda unos segundos.",
