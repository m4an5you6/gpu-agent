...
| | |
|---|---|
| Source | Optional — install with `gpucloud skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"GPUCLOUD","productType":"Apparel","tags":["test"]}}'
```
