...
def _load_plugin_init():
    ...
    mod = importlib.util.module_from_spec(spec)
    mod.__package__ = "gpucloud_plugins.disk_cleanup"
    mod.__path__ = [str(plugin_dir)]
    sys.modules["gpucloud_plugins.disk_cleanup"] = mod
    spec.loader.exec_module(mod)
    return mod
...
class TestIsSafePath:
    ...
    def test_accepts_tmp_gpucloud_prefix(self, _isolate_env, tmp_path):
        dg = _load_lib()
