...
- User wants **GPUCLOUD itself to drive a browser** → use GPUCLOUD' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
