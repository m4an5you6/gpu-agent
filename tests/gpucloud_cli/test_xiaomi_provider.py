...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from gpucloud_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in GPUCLOUD_OVERLAYS
        overlay = GPUCLOUD_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify gpucloud doctor recognizes Xiaomi env vars."""
