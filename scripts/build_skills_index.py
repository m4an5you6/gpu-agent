#!/usr/bin/env python3
"""Build the GPUCLOUD Skills Index — a centralized JSON catalog of all skills.
...
`gpucloud skills search/install` can use it without hitting the GitHub API.
...
# Ensure GPUCLOUD_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building GPUCLOUD Skills Index...", flush=True)
