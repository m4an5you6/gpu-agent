...
from gpucloud_constants import PARTIAL_STREAM_STUB_ID
    ...
    while (api_call_count < agent.max_iterations and agent.iteration_budget.remaining > 0) or agent._budget_grace_call:
        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                try:
                    from gpucloud_cli.middleware import apply_llm_request_middleware
                ...
                from gpucloud_cli.middleware import run_llm_execution_middleware
                ...
                if (
                    ...
                    agent._vprint(
                        f"{agent.log_prefix}      Use the `copilot` provider with a Copilot subscription token (`gpucloud",
                        force=True,
                    )
                    agent._vprint(
                    ...
                    if classified.is_auth or classified.reason == FailoverReason.billing:
                        if classified.reason == FailoverReason.billing and _print_billing_or_entitlement_guidance(
                            ...
                            if _provider == "openai-codex":
                                ...
                                agent._vprint(f"{agent.log_prefix}      1. Re-authenticate: gpucloud portal", force=True)
