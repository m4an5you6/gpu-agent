...
import type { ScrollBoxHandle } from '@gpucloud/ink'
import { evictInkCaches } from '@gpucloud/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.GPUCLOUD_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
