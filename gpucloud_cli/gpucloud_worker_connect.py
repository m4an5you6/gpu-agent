...
from gpucloud_cli.gpucloud_probe import probe_local_gpu
from gpucloud_cli.gpucloud_worker import run_worker_logs, run_worker_stop
from gpucloud_cli.gpucloud_worker_goal import run_worker_goal_run
...
def default_worker_task_dir() -> Path:
    return get_gpucloud_home() / "gpucloud" / "wss_worker_tasks"
