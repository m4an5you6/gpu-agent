...
def build_parser(parent_subparsers: argparse._SubParsersAction) -> argparse.ArgumentParser:
    ...
    kanban_parser = parent_subparsers.add_parser(
        ...
        description=(
            ...
            "See the GPUCLOUD kanban documentation for the full design."
        ),
    )
    # --- global --board flag ---
    ...
    kanban_parser.add_argument(
        ...
        help=(
            ...
            "kanban board environment override). Use `gpucloud kanban boards list` "
            "to see all boards."
        ),
    )
...
def kanban_command(args: argparse.Namespace) -> int:
    ...
    prev_board_env = os.environ.get("GPUCLOUD_KANBAN_BOARD")
    ...
    def _restore_board_env() -> None:
        ...
        if prev_board_env is None:
            ...
            os.environ["GPUCLOUD_KANBAN_BOARD"] = prev_board_env
    if board_override:
        try:
        ...
        if normed != kb.DEFAULT_BOARD and not kb.board_exists(normed):
            ...
            return 1
        os.environ["GPUCLOUD_KANBAN_BOARD"] = normed
