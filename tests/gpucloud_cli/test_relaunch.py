...
class TestResolveGPUCLOUDBin:
    ...
    def test_falls_back_to_path_which(self, monkeypatch):
        ...
        assert relaunch_mod.resolve_hermes_bin() == "/usr/bin/gpucloud"
...
class TestBuildRelaunchArgv:
    def test_uses_bin_when_available(self, monkeypatch):
        monkeypatch.setattr(relaunch_mod, "resolve_hermes_bin", lambda: "/usr/bin/gpucloud")
...
class TestResolveGPUCLOUDBinWindowsPyGuard:
    ...
    def test_windows_rejects_py_argv0_falls_through_to_path(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr(
            ...
            lambda name: r"C:\venv\Scripts\hermes.exe" if name == "gpucloud" else None,
        )
