...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateGPUCLOUD: "Mettre à jour GPUCLOUD",
    updatingGPUCLOUD: "Mise à jour de GPUCLOUD…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins GPUCLOUD (parité avec `gpucloud plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.gpucloud/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.gpucloud/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.gpucloud/skills/",
  ...
  config: {
    configPath: "~/.gpucloud/config.yaml",
    filters: "Filtres",
    sections: "Sections",
  ...
  achievements: {
    hero: {
      ...
      title: "GPUCLOUD Achievements",
      subtitle:
        "Badges GPUCLOUD à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions GPUCLOUD en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez GPUCLOUD davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'GPUCLOUD détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "GPUCLOUD analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in GPUCLOUD Agent ☤",
    },
  },
  kanban: {
