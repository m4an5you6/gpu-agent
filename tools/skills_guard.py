...
Trust levels:
  - builtin:   Ships with GPUCLOUD. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.gpucloud/\.env|\~/\.gpucloud/\.env',
     "gpucloud_env_access", "critical", "exfiltration",
     "directly references GPUCLOUD secrets file"),
    ...
    (r'\.gpucloud/config\.yaml|\.gpucloud/SOUL\.md',
     "gpucloud_config_mod", "critical", "persistence",
     "references GPUCLOUD configuration files directly"),
...
# scan. `.skillignore` is the GPUCLOUD-native name; `.clawhubignore` is honored
