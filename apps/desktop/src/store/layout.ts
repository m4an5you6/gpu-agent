...
const SIDEBAR_PINNED_STORAGE_KEY = 'gpucloud.desktop.pinnedSessions'
const SIDEBAR_AGENTS_GROUPED_STORAGE_KEY = 'gpucloud.desktop.agentsGroupedByWorkspace'
const SIDEBAR_CRON_OPEN_STORAGE_KEY = 'gpucloud.desktop.sidebarCronOpen'
const SIDEBAR_SESSION_ORDER_STORAGE_KEY = 'gpucloud.desktop.sessionOrder'
const SIDEBAR_WORKSPACE_ORDER_STORAGE_KEY = 'gpucloud.desktop.workspaceOrder'
const PANES_FLIPPED_STORAGE_KEY = 'gpucloud.desktop.panesFlipped'
...
export const SESSION_SEARCH_FOCUS_EVENT = 'gpucloud:focus-session-search'
