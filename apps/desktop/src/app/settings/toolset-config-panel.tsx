...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/gpucloud'
 ...
 * log inline — the GUI equivalent of the install step `gpucloud tools` runs
