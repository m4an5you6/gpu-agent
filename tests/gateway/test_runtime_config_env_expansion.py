...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("GPUCLOUD_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("GPUCLOUD_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("GPUCLOUD_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
