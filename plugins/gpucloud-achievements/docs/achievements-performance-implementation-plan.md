# GPUCLOUD Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.gpucloud/plugins/gpucloud-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.gpucloud/plugins/gpucloud-achievements/scan_checkpoint.json`.
