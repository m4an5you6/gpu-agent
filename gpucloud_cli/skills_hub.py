...
def do_browse(page: int = 1, page_size: int = 20, source: str = "all",
    ...
    c.print("[dim]Tip: 'gpucloud skills search <query>' searches deeper across all registries[/]\n")
...
def skills_command(args) -> None:
    ...
    if action == "browse":
        ...
        _console.print("Usage: gpucloud skills [browse|search|install|inspect|list|check|update|audit|uninstall|reset|publish|snapshot|tap]\n")
