...
def _profile_user_agent() -> str:
    """Return a ``gpucloud-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from gpucloud_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"gpucloud-cli/{_ver}"
    except Exception:
        return "gpucloud-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # gpucloud-cli UA so the catalog endpoint is reachable.
