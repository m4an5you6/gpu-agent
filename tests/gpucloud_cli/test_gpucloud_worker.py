...
def test_worker_preflight_reports_missing_gpu(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "gpucloud_cli.gpucloud_worker.probe_local_gpu",
        lambda: {
            "target": "local",
            "available": False,
            "skipped": True,
    ...
    monkeypatch.setattr(
        "gpucloud_cli.gpucloud_worker._torch_probe",
        lambda python: {
            "ok": True,
            "cuda_available": True,
...
def test_worker_start_status_logs_and_stop(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "gpucloud_cli.gpucloud_worker.run_worker_preflight",
    ...
    monkeypatch.setattr("gpucloud_cli.gpucloud_worker.subprocess.Popen", DummyPopen)
    monkeypatch.setattr("gpucloud_cli.gpucloud_worker._pid_running", lambda pid: True)
    ...
    monkeypatch.setattr("gpucloud_cli.gpucloud_worker._terminate_pid", lambda pid: "terminated")
...
def test_swift_megatron_multinode_requires_shared_modelscope_cache(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("gpucloud_cli.gpucloud_worker.shutil.which", lambda name: "/usr/bin/megatron")
