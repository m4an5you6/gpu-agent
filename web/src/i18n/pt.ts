...
export const pt: Translations = {
  ...
  status: {
    ...
    stopped: "Parado",
    updateGPUCLOUD: "Atualizar GPUCLOUD",
    updatingGPUCLOUD: "A atualizar GPUCLOUD…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descobrir, instalar, ativar e atualizar plugins GPUCLOUD (paridade com `gpucloud plugins`).",
    ...
    removeConfirm: "Remover este plugin de ~/.gpucloud/plugins/?",
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.gpucloud/plugins podem ser removidos.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.gpucloud/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Distintivos colecionáveis do GPUCLOUD obtidos a partir do histórico real de sessões. Conquistas conhecidas mas ainda não obtidas aparecem como Descobertas; conquistas Secretas permanecem ocultas até surgir o primeiro comportamento correspondente.",
      scan_subtitle:
        "A analisar o histórico de sessões do GPUCLOUD. A primeira análise pode demorar 5–10 segundos em históricos extensos.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Mais recente",
      latest_hint_empty: "execute mais o GPUCLOUD",
    ...
    guide: {
      ...
      secret_body:
        "As secretas escondem o seu acionador exato. Assim que o GPUCLOUD detetar um sinal relacionado, o cartão passa a Descoberta e mostra o requisito.",
      scan_status_header: "Estado da análise",
      scan_status_body:
        "O GPUCLOUD analisa o histórico local uma vez e depois os cartões aparecem automaticamente. Nada está bloqueado se isto demorar alguns segundos.",
