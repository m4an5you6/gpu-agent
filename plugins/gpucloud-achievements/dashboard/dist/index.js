(function () {
  ...
  async function api(path, options) {
    ...
    if (token) headers["X-GPUCLOUD-Session-Token"] = token;
  ...
  async function buildShareImage(achievement) {
    ...
    ctx.fillText("HERMES AGENT  ·  gpucloud-agent.nousresearch.com", 70, H - 40);
  ...
  window.__GPUCLOUD_PLUGINS__.register("hermes-achievements", AchievementsPage);
})();
