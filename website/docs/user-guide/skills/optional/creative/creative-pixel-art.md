...
| | |
|---|---|
| Source | Optional — install with `gpucloud skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.gpucloud/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.gpucloud/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — GPUCLOUD installs package this)
