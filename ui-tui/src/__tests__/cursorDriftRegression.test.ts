 ...
 *
 * Symptom: in `gpucloud --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@gpucloud/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using gpucloud --tui and as i type multiline my caret at the end will often ' +
