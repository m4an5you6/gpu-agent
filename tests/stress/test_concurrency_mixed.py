...
def worker_loop(worker_id: int, gpucloud_home: str, result_file: str) -> None:
...
def reclaimer_loop(gpucloud_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="gpucloud_mixed_stress_")
    print(f"GPUCLOUD_HOME = {home}")
