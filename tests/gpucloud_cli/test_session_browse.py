"""Tests for the interactive session browser (`gpucloud sessions browse`).
...
from gpucloud_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """gpucloud sessions browse should be parseable."""
        from gpucloud_cli.main import main as _main_entry
