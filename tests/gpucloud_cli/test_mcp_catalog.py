...
class TestInstall:
    ...
    def test_install_required_env_missing_raises(self, catalog_dir, monkeypatch):
        ...
        from gpucloud_cli import mcp_catalog
        from gpucloud_cli.mcp_catalog import install_entry, CatalogError
...
class TestUninstall:
    def test_uninstall_removes_server_block(self, catalog_dir):
        _write_manifest(catalog_dir, "demo", _basic_manifest())
        from gpucloud_cli.mcp_catalog import install_entry, uninstall_entry
        from gpucloud_cli.config import load_config
