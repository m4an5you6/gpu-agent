...
class LongPreviewAgent:
    ...
    LONG_CMD = "cd /home/teknium/.gpucloud/gpucloud-agent/.worktrees/gpucloud-d8860339 && source .venv/bin/activate && python -m pytest tests/gateway/test_run_progress_topics.py -n0 -q"
...
async def test_run_agent_progress_stays_in_originating_topic(monkeypatch, tmp_path):
    monkeypatch.setenv("GPUCLOUD_TOOL_PROGRESS_MODE", "all")
...
async def test_terminal_progress_no_bash_block_in_verbose_mode(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("GPUCLOUD_TOOL_PROGRESS_MODE", "verbose")
