...
import type { SessionInfo, UsageStats } from '@/types/gpucloud'

type Updater<T> = T | ((current: T) => T)

const WORKSPACE_CWD_KEY = 'gpucloud.desktop.workspace-cwd'
...
export const $connection = atom<GPUCLOUDConnection | null>(null)
...
export const setConnection = (next: Updater<GPUCLOUDConnection | null>) => updateAtom($connection, next)
