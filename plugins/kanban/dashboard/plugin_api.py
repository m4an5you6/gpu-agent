...
def _ws_upgrade_authorized(ws: "WebSocket") -> bool:
    ...
    WS auth gate (``gpucloud_cli.web_server._ws_auth_ok``).
...
def specify_task_endpoint(
    ...
    # GPUCLOUD_KANBAN_BOARD env var — this endpoint runs in FastAPI's
...
def decompose_task_endpoint(
    ...
    # GPUCLOUD_KANBAN_BOARD env var would let concurrent requests for
