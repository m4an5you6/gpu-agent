...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should GPUCLOUD look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} GPUCLOUD need to see?`,
    ...
    {
      headline: `What should ${label} GPUCLOUD tackle?`,
