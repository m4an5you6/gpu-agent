"""Tests for the ``gpucloud prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from gpucloud_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(gpucloud_home, memory_text="", user_text=""):
    mem_dir = gpucloud_home / "memories"
...
def _seed_skill(gpucloud_home, name, description):
    skill_dir = gpucloud_home / "skills" / "demo" / name
