...
the get_anchored_view / get_messages_around primitives in gpucloud_state.
...
# Third-party integrations tag their sessions with GPUCLOUD_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from gpucloud_state import DEFAULT_DB_PATH
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another GPUCLOUD profile's database "
