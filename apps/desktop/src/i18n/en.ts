...
export const en: Translations = {
  ...
  boot: {
    ready: 'GPUCLOUD Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading GPUCLOUD settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingGPUCLOUDDesktop: 'Starting GPUCLOUD Desktop…'
    },
    errors: {
      backgroundExited: 'GPUCLOUD background process exited.',
      backgroundExitedDuringStartup: 'GPUCLOUD background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your GPUCLOUD backend is older than this desktop build and may not work correctly. Update to align them.',
    updateGPUCLOUD: 'Update GPUCLOUD',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting GPUCLOUD Desktop.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to GPUCLOUD defaults?',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let GPUCLOUD follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'GPUCLOUD checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading GPUCLOUD configuration...',
    ...
    gateway: {
      ...
      intro:
        'GPUCLOUD Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running GPUCLOUD backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset GPUCLOUD_DESKTOP_REMOTE_URL and GPUCLOUD_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private GPUCLOUD backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote GPUCLOUD backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /gpucloud.',
      ...
      restartingMessage: 'GPUCLOUD Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · GPUCLOUD ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. GPUCLOUD runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure GPUCLOUD desktop' },
    ...
    gpucloudActiveSessions: (version, count) => `GPUCLOUD ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@gpucloud:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent GPUCLOUD environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. GPUCLOUD will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting GPUCLOUD...',
    placeholderReconnecting: 'Reconnecting to GPUCLOUD…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give GPUCLOUD a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'GPUCLOUD will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of GPUCLOUD can’t update itself from inside the app.',
    ...
    manualBody: 'You installed GPUCLOUD from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'GPUCLOUD will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The GPUCLOUD updater will take over in its own window and reopen GPUCLOUD when it’s done.',
    applyingBodyBackend: 'The remote backend is applying the update and will restart. GPUCLOUD reconnects automatically when it’s back.',
    applyingClose: 'GPUCLOUD will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'GPUCLOUD needs a one-time install',
    ...
    settingUpTitle: 'Setting up GPUCLOUD Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another GPUCLOUD CLI or desktop instance is running. Stop any running GPUCLOUD instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The GPUCLOUD installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with GPUCLOUD Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'GPUCLOUD is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting GPUCLOUD…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run GPUCLOUD',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point GPUCLOUD at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — GPUCLOUD connects automatically',
      loopback: 'Opens your browser to sign in — GPUCLOUD connects automatically',
    ...
    authorizeThere: 'Authorize GPUCLOUD there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize GPUCLOUD there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'GPUCLOUD inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. GPUCLOUD will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'GPUCLOUD is restarting...',
      askRestart: 'Ask GPUCLOUD to restart the server',
      lookingRestart: taskId => `GPUCLOUD is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'GPUCLOUD is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `GPUCLOUD finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'GPUCLOUD could not restart the server.',
      stillWorking:
        'GPUCLOUD is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'GPUCLOUD is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'GPUCLOUD gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.gpucloud/config.yaml). GPUCLOUD won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'GPUCLOUD needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'GPUCLOUD needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart GPUCLOUD Desktop to use Save Image.',
    restartToSaveImages: 'Restart GPUCLOUD Desktop to save images',
