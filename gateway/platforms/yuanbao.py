...
try:
    ...
    _GPUCLOUD_VERSION = "0.0.0"

_APP_VERSION = _GPUCLOUD_VERSION
_BOT_VERSION = _GPUCLOUD_VERSION
_YUANBAO_INSTANCE_ID = str(GPUCLOUD_INSTANCE_ID)  # single source: yuanbao_proto.GPUCLOUD_INSTANCE_ID
