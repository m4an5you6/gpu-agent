...
**Not natively.** GPUCLOUD Agent requires a Unix-like environment. On Windows, install [WSL2](https://learn.microsoft.com/en-us/windows/wsl/install) and run GPUCLOUD from inside it. The standard install command works perfectly in WSL2:
...
- [Use MCP with GPUCLOUD](../guides/use-mcp-with-gpucloud.md#wsl2-bridge-hermes-in-wsl-to-windows-chrome)
