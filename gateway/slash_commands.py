...
Module-level run.py helpers a handler needs (``_gpucloud_home``,
...
class GatewaySlashCommandsMixin:
    ...
    async def _handle_restart_command(self, event: MessageEvent) -> Union[str, EphemeralReply]:
        ...
        from gateway.run import _gpucloud_home
    ...
    async def _handle_version_command(self, event: MessageEvent) -> str:
        """Handle /version — show the running GPUCLOUD Agent version."""
    ...
    async def _handle_model_command(self, event: MessageEvent) -> Optional[str]:
        ...
        """
        from gateway.run import _gpucloud_home, _load_gateway_config
        import yaml
    ...
    async def _handle_reasoning_command(self, event: MessageEvent) -> str:
        ...
        """
        from gateway.run import _gpucloud_home, _platform_config_key
        import yaml
    ...
    async def _handle_fast_command(self, event: MessageEvent) -> str:
        ...
        from gateway.run import _gpucloud_home, _load_gateway_config, _resolve_gateway_model
        import yaml
    ...
    async def _handle_verbose_command(self, event: MessageEvent) -> str:
        ...
        """
        from gateway.run import _gpucloud_home, _load_gateway_config, _platform_config_key
    ...
    async def _handle_footer_command(self, event: MessageEvent) -> str:
        ...
        """
        from gateway.run import _gpucloud_home, _load_gateway_config, _platform_config_key, _resolve_gateway_model
    ...
    async def _handle_update_command(self, event: MessageEvent) -> str:
        ...
        """
        from gateway.run import _gpucloud_home, _resolve_gpucloud_bin
        import json
        import shutil
        import subprocess
        from datetime import datetime
        ...
        try:
            if sys.platform == "win32":
                ...
                # gpucloud_cmd is a list of argv parts we can pass directly
                ...
                gpucloud_cmd_str = " ".join(shlex.quote(part) for part in gpucloud_cmd)
                update_cmd = (
                    f"PYTHONUNBUFFERED=1 {gpucloud_cmd_str} update --gateway"
