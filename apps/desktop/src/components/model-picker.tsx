...
import type { ModelOptionProvider, ModelOptionsResponse, ModelPricing } from '@/types/gpucloud'
...
export function ModelPickerDialog({
  ...
  // the `gpucloud model` CLI picker, which shows the curated list verbatim.
