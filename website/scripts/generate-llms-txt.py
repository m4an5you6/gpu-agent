#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the GPUCLOUD docs site.
...
Both publish at:
  https://gpucloud-agent.nousresearch.com/docs/llms.txt
  https://gpucloud-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://gpucloud-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use GPUCLOUD as a Python Library", None),
        ("guides/use-mcp-with-gpucloud", "Use MCP with GPUCLOUD", None),
        ("guides/use-voice-mode-with-gpucloud", "Use Voice Mode with GPUCLOUD", None),
        ("guides/use-soul-with-gpucloud", "Use SOUL.md with GPUCLOUD", None),
        ("guides/build-a-gpucloud-plugin", "Build a GPUCLOUD Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with GPUCLOUD"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "gpucloud-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/gpucloud-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# GPUCLOUD Agent — Full Documentation\n",
        (
            "This file is the entire GPUCLOUD Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using GPUCLOUD, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://gpucloud-agent.nousresearch.com/docs\n",
        "Short index: https://gpucloud-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
