...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.gpucloud/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at gpucloud_state import time, before pytest's GPUCLOUD_HOME monkeypatch
    fires — the autouse fixture's GPUCLOUD_HOME override doesn't help here.)
    """
