...
The main() function in gpucloud_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `gpucloud -c model`
...
def _build_parser():
    """Build a minimal replica of the gpucloud top-level parser."""
