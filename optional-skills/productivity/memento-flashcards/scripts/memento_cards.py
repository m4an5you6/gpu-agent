...
Data file: $GPUCLOUD_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_GPUCLOUD_HOME = Path(os.environ.get("GPUCLOUD_HOME", Path.home() / ".gpucloud"))
DATA_DIR = _GPUCLOUD_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
