...
import { deleteSession, listSessions, setSessionArchived } from '@/gpucloud'
...
import type { SessionInfo } from '@/types/gpucloud'
...
// / Program Files), which buried any files GPUCLOUD wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.gpucloudDesktop` is
    ...
    const settings = window.gpucloudDesktop?.settings
  ...
  return (
    <div className="mb-6">
      ...
      <ListRow
        ...
        description={dir || s.defaultsTo(fallback || '~/gpucloud-projects')}
