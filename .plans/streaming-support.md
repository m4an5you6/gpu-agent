# Streaming LLM Response Support for GPUCLOUD Agent
...
```
GPUCLOUD_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("GPUCLOUD_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `gpucloud_cli/config.py` | 1 | +streaming config defaults |
...
GPUCLOUD_STREAMING_ENABLED=true
```
