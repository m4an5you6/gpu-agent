...
```bash
python3 -m pyfiglet "GPUCLOUD" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=GPUCLOUD&font=Slant" | boxes -d stone
```
