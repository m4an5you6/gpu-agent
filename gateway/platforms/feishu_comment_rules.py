...
Config: ~/.gpucloud/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.gpucloud/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_gpucloud_home()`` helper (GPUCLOUD_HOME-aware and
...
RULES_FILE = get_gpucloud_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_gpucloud_home() / "feishu_comment_pairing.json"
