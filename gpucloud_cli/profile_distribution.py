...
class DistributionManifest:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.gpucloud_requires:
            out["hermes_requires"] = self.gpucloud_requires
        if self.author:
...
def plan_install(
    ...
    from gpucloud_cli import __version__ as hermes_version
    ...
    check_hermes_requires(manifest.gpucloud_requires, hermes_version)
