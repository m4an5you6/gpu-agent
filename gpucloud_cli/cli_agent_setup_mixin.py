"""Agent-construction and session-resume display methods for ``GPUCLOUDCLI``.

Extracted from ``cli.py`` as part of the god-file decomposition campaign
(``~/.gpucloud/plans/god-file-decomposition.md``, Phase 4 step 2). This mixin holds
...
Behavior-neutral: every method is lifted verbatim from ``GPUCLOUDCLI``. ``self.*``
...
class CLIAgentSetupMixin:
    """Agent construction + session-resume display methods for ``GPUCLOUDCLI``."""
