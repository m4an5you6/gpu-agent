...
TIPS = [
    ...
    # --- CLI Flags ---
    "hermes -c resumes your most recent CLI session. gpucloud -c \"project name\" resumes by title.",
    ...
    "hermes backup creates a zip backup of your entire GPUCLOUD home directory.",
    ...
    "SOUL.md at ~/.gpucloud/SOUL.md is the agent's primary identity — customize it to shape behavior.",
    ...
    "SOUL.md is auto-seeded with a default personality on first run. Edit ~/.gpucloud/SOUL.md to customize.",
    ...
    'gpucloud dashboard --tui embeds the full GPUCLOUD TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    'gpucloud chat --ignore-user-config skips ~/.gpucloud/config.yaml — reproducible bug reports and CI runs.',
