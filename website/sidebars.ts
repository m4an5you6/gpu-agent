...
const sidebars: SidebarsConfig = {
  docs: [
              ...
              items: [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    'user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-gpucloud-agent',
                ...
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    'user-guide/skills/bundled/software-development/software-development-debugging-gpucloud-tui-commands',
                    'user-guide/skills/bundled/software-development/software-development-gpucloud-agent-skill-authoring',
                    'user-guide/skills/bundled/software-development/software-development-gpucloud-s6-container-supervision',
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        'guides/run-gpucloud-with-nous-portal',
        'guides/tips',
        'guides/local-llm-on-mac',
        'guides/daily-briefing-bot',
        'guides/team-telegram-assistant',
        'guides/python-library',
        'guides/use-mcp-with-gpucloud',
        'guides/use-soul-with-gpucloud',
        'guides/use-voice-mode-with-gpucloud',
        'guides/build-a-gpucloud-plugin',
