 ...
 * `window.__GPUCLOUD_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the GPUCLOUD brand in the top bar
 ...
 *  `window.__GPUCLOUD_PLUGINS__.registerSlot(...)`.
 *
