# nix/web.nix — GPUCLOUD Web Dashboard (Vite/React) frontend build
{ pkgs, gpucloudNpmLib, ... }:
let
  npm = gpucloudNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "gpucloud-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../gpucloud_cli/web_dist for the
