...
| | |
|---|---|
| Source | Optional — install with `gpucloud skills install official/health/neuroskill-bci` |
...
Connect GPUCLOUD to a running [NeuroSkill](https://neuroskill.com/) instance to read
