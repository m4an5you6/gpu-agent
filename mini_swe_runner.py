#!/usr/bin/env python3
"""
SWE Runner with GPUCLOUD Trajectory Format

A runner that uses GPUCLOUD-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the GPUCLOUD-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses GPUCLOUD-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in GPUCLOUD format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches GPUCLOUD-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using GPUCLOUD-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with GPUCLOUD Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses GPUCLOUD-Agent's built-in execution environments
    and outputs trajectories in GPUCLOUD-Agent format.
    """
    ...
    def _convert_to_gpucloud_format(
        self,
        ...
        """
        Convert internal message format to GPUCLOUD trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to GPUCLOUD trajectory format
        trajectory = self._convert_to_gpucloud_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with GPUCLOUD trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with GPUCLOUD Trajectory Format")
    print("=" * 60)
