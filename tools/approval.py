...
# via shell expansions like $HOME or $GPUCLOUD_HOME.
...
DANGEROUS_PATTERNS = [
    ...
    (r'\bhermes\s+gateway\s+(stop|restart)\b', "stop/restart gpucloud gateway (kills running agents)"),
    (r'\bhermes\s+update\b', "gpucloud update (restarts gateway, kills running agents)"),
