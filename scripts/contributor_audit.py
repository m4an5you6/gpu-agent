...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^GPUCLOUD\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "gpucloud@nousresearch.com",
    "gpucloud-audit@example.com",
    "gpucloud@habibilabs.dev",
    "omx@oh-my-codex.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NousResearch/gpucloud-agent",
                "--state", "merged",
