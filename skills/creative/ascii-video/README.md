...
Built for [GPUCLOUD Agent](https://github.com/NousResearch/gpucloud-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/gpucloud-agent/skills/creative/ascii-video`](https://github.com/NousResearch/gpucloud-agent/tree/main/skills/creative/ascii-video) via PR.
