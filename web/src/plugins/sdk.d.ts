/**
 * GPUCLOUD Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__GPUCLOUD_PLUGIN_SDK__`` and
 * ``window.__GPUCLOUD_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__GPUCLOUD_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``GPUCLOUDPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@gpucloud/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__GPUCLOUD_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__GPUCLOUD_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__GPUCLOUD_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface GPUCLOUDPluginSDK {
...
declare global {
  interface Window {
    __GPUCLOUD_PLUGIN_SDK__?: GPUCLOUDPluginSDK;
    __GPUCLOUD_PLUGINS__?: PluginRegistry;
  }
}
