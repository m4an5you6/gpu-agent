...
``cli.py``'s ``GPUCLOUDCLI`` class. ``GPUCLOUDCLI`` inherits ``CLICommandsMixin`` so
...
from gpucloud_constants import display_gpucloud_home, is_termux as _is_termux_environment
