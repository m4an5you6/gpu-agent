...
from gpucloud_cli.gpucloud_distributed import build_worker_plan, quote_shell_arg, worker_env
from gpucloud_cli.gpucloud_goal import infer_goal_intent
...
from gpucloud_cli.gpucloud_worker_task import (
    WorkerTask,
    WorkerTaskError,
    load_worker_task,
...
def worker_goal_state_dir() -> Path:
    ...
    path = Path(override).expanduser() if override else get_gpucloud_home() / "gpucloud" / "worker_goal_runs"
