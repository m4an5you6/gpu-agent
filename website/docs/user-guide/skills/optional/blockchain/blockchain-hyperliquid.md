...
| | |
|---|---|
| Source | Optional — install with `gpucloud skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), GPUCLOUD Agent |
| License | MIT |
...
The script reads `~/.gpucloud/.env` for two optional defaults:
...
Helper script: `~/.gpucloud/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.gpucloud/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.gpucloud/.env`.
...
```bash
python3 ~/.gpucloud/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.gpucloud/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
