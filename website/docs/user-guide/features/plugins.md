...
| Distribute via pip | `[project.entry-points."gpucloud_agent.plugins"]` |
...
| pip | `gpucloud_agent.plugins` entry_points | Distributed packages |
...
gpucloud plugins enable my-plugin              # add to allow-list
