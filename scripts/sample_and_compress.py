...
DEFAULT_DATASETS = [
    ...
    "NousResearch/gpucloud-agent-megascience-sft1",
    "NousResearch/GPUCLOUD-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/GPUCLOUD-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-gpucloud-agent"
]
