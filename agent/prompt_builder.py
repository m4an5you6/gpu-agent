...
_GPUCLOUD_MD_NAMES = (".gpucloud.md", "HERMES.md")


def _find_hermes_md(cwd: Path) -> Optional[Path]:
    """Discover the nearest ``.gpucloud.md`` or ``HERMES.md``.
...
GPUCLOUD_AGENT_HELP_GUIDANCE = (
    "If the user asks about configuring, setting up, or using GPUCLOUD Agent "
    "itself, load the `gpucloud-agent` skill with skill_view(name='gpucloud-agent') "
    "before answering. Docs: https://gpucloud-agent.nousresearch.com/docs"
)
...
def _load_hermes_md(cwd_path: Path) -> str:
    """.gpucloud.md / HERMES.md — walk to git root."""
...
def build_context_files_prompt(cwd: Optional[str] = None, skip_soul: bool = False) -> str:
    ...
    Priority (first found wins — only ONE project context type is loaded):
      1. .gpucloud.md / HERMES.md  (walk to git root)
