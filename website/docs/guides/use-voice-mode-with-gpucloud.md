---
sidebar_position: 8
title: "Use Voice Mode with GPUCLOUD"
description: "A practical guide to setting up and using GPUCLOUD voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with GPUCLOUD
...
- you want GPUCLOUD sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in GPUCLOUD.
...
## Step 1: make sure normal GPUCLOUD works first
...
GPUCLOUD supports both local and cloud speech stacks.
...
4. GPUCLOUD transcribes and responds
...
- asking GPUCLOUD to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full GPUCLOUD loop.

## Tuning CLI behavior

### Silence threshold

If GPUCLOUD starts/stops too aggressively, tune:
...
GPUCLOUD stays a normal chat bot, but can speak replies.
...
- you want GPUCLOUD to function like a portable research or ops assistant
...
GPUCLOUD joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- GPUCLOUD detects speech boundaries
- transcripts are posted in the associated text channel
- GPUCLOUD responds in text and audio
...
1. get text GPUCLOUD working
2. install `gpucloud-agent[voice]`
