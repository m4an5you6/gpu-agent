...
_gpucloud_profiles() {{
    local profiles_dir="$HOME/.gpucloud/profiles"
...
_gpucloud_profiles() {{
    local -a profiles
    profiles=(default)
    if [[ -d "$HOME/.gpucloud/profiles" ]]; then
        profiles+=($HOME/.gpucloud/profiles/*(N/:t))
    fi
...
def generate_fish(parser: argparse.ArgumentParser) -> str:
    ...
    lines: list[str] = [
        ...
        "    echo default",
        "    if test -d $HOME/.gpucloud/profiles",
        "        for d in $HOME/.gpucloud/profiles/*/",
        "            basename $d",
        "        end",
        "    end",
        "end",
