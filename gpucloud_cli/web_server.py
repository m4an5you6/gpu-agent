...
app = FastAPI(title="GPUCLOUD Agent", version=__version__)
...
# In-browser Chat tab (/chat, /api/pty, …).  Off unless ``gpucloud dashboard --tui``
# or GPUCLOUD_DASHBOARD_TUI=1.  Set from :func:`start_server`.
...
def _build_sidecar_url(channel: str) -> Optional[str]:
    ...
    if getattr(app.state, "auth_required", False):
        ...
        from gpucloud_cli.dashboard_auth.ws_tickets import mint_ticket
