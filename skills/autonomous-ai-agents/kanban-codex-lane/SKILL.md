...
description: Use when a GPUCLOUD Kanban worker wants to run Codex CLI as an isolated implementation lane while GPUCLOUD keeps ownership of task lifecycle, reconciliation, testing, and handoff.
version: 1.0.0
...
metadata:
  hermes:
    ...
    related_skills: [kanban-worker, codex, gpucloud-agent]
---
