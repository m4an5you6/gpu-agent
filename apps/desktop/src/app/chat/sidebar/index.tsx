...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/gpucloud'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('gpucloud:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('gpucloud:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
