...
Invoked by ``gpucloud kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the GPUCLOUD Agent board.
...
def _profile_author() -> str:
    """Mirror of ``gpucloud_cli.kanban._profile_author``."""
    return (
