...
| | |
|---|---|
| Source | Optional — install with `gpucloud skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | GPUCLOUD Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $GPUCLOUD_OSINT_CACHE/icij/ (default: ~/.cache/gpucloud-osint/icij/).
...
# Set GPUCLOUD_OSINT_UA=your-app/1.0 (your@email) to identify yourself
