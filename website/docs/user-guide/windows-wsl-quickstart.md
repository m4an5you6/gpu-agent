...
- **[MCP guide → WSL → Windows Chrome](/guides/use-mcp-with-gpucloud#wsl2-bridge-hermes-in-wsl-to-windows-chrome)** — controlling your signed-in Windows Chrome from GPUCLOUD in WSL.
