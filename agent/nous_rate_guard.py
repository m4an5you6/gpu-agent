...
(3 SDK retries x 3 GPUCLOUD retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_gpucloud_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".gpucloud")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, GPUCLOUD, ...) behind one endpoint.  A 429 can mean either:
