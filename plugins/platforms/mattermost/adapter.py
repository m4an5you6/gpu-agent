...
required — uses aiohttp which is already a GPUCLOUD dependency.
...
def interactive_setup() -> None:
    ...
    ``gpucloud_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where GPUCLOUD delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # gpucloud_cli/setup.py::_setup_mattermost function.
