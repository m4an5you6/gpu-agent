...
const config: Config = {
  ...
  url: 'https://gpucloud-agent.nousresearch.com',
  baseUrl: '/docs/',

  organizationName: 'NousResearch',
  projectName: 'gpucloud-agent',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/NousResearch/gpucloud-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/gpucloud-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://gpucloud-agent.nousresearch.com/desktop',
          label: 'Download',
          position: 'left',
        },
        {
        ...
        {
          href: 'https://gpucloud-agent.nousresearch.com',
          label: 'Home',
          position: 'right',
        },
        {
          href: 'https://github.com/NousResearch/gpucloud-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/NousResearch/gpucloud-agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://gpucloud-agent.nousresearch.com/desktop' },
            { label: 'GitHub', href: 'https://github.com/NousResearch/gpucloud-agent' },
