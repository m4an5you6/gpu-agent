# GPUCLOUD Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.gpucloud/plugins/gpucloud-achievements/state.json` (existing unlock state)
  - `~/.gpucloud/plugins/gpucloud-achievements/scan_snapshot.json` (new)
  - `~/.gpucloud/plugins/gpucloud-achievements/scan_checkpoint.json` (new)
