...
def build_user_agent() -> str:
    ...
    Format::
        ...
        QQBotAdapter/<qqbot_version> (Python/<py_version>; <os>; GPUCLOUD/<hermes_version>)
    ...
    return f"QQBotAdapter/{QQBOT_VERSION} (Python/{py_version}; {os_name}; GPUCLOUD/{hermes_version})"
