...
from gpucloud_cli.gpucloud_phase2 import GPUCLOUD_CORE_TOOLS


# GPUCLOUD phase 2 default CLI/cron tool surface (ML agent core).
_GPUCLOUD_CORE_TOOLS = list(GPUCLOUD_CORE_TOOLS)
...
TOOLSETS = {
    ...
    "gpucloud": {
        "description": "GPUCLOUD SSH/GPU, training, checkpoint, and vLLM inference tools",
        "tools": [
