...
| `hermes-achievements` | dashboard tab | Steam-style collectible badges generated from your real GPUCLOUD session history |
...
Or check the box in the interactive `gpucloud plugins` UI. Then put the credentials in `~/.gpucloud/.env`:
