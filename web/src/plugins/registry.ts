 ...
 *
 * Plugins call window.__GPUCLOUD_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__GPUCLOUD_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__GPUCLOUD_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__GPUCLOUD_PLUGIN_SDK__ = {
    ...
    // window.__GPUCLOUD_SESSION_TOKEN__ directly.
    authedFetch,
