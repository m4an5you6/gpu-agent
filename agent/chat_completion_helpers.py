...
def interruptible_api_call(agent, api_kwargs: dict):
    ...
    _ttfb_timeout = _env_float("GPUCLOUD_CODEX_TTFB_TIMEOUT_SECONDS", 12.0)
    if _ttfb_timeout <= 0:
        _ttfb_enabled = False
        ...
        if (
            ...
            _ttfb_cap = _env_float("GPUCLOUD_CODEX_TTFB_MAX_SECONDS", 20.0)
...
def interruptible_streaming_api_call(agent, api_kwargs: dict, *, on_first_delta=None):
    ...
    def _call():
        ...
        _max_stream_retries = int(os.getenv("GPUCLOUD_STREAM_RETRIES", 2))
