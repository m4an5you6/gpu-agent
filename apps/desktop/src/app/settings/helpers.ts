import type { GPUCLOUDConfigRecord, ToolsetInfo } from '@/types/gpucloud'
...
export function getNested(obj: GPUCLOUDConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: GPUCLOUDConfigRecord, path: string, value: unknown): GPUCLOUDConfigRecord {
...
function personalityOptions(config: GPUCLOUDConfigRecord): string[] {
