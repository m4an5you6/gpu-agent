...
cd apps/desktop
XCURSOR_SIZE=24 GPUCLOUD_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/gpucloud-typing
# → /tmp/gpucloud-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/gpucloud-typing.before.heapsnapshot
# → /tmp/gpucloud-typing.after.heapsnapshot
```
