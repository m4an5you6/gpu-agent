...
def test_checkpoint_list_identifies_latest(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("gpucloud_cli.gpucloud_checkpoints.run_ssh_command", fake_ssh)
...
def test_train_resume_dry_run_uses_validated_checkpoint(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "gpucloud_cli.gpucloud_checkpoints.run_checkpoint_validate",
        fake_validate,
    )
...
def test_checkpoint_cleanup_defaults_to_dry_run(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "gpucloud_cli.gpucloud_checkpoints.run_checkpoint_list",
        fake_list,
    )
