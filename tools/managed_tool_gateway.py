...
def auth_json_path():
    """Return the GPUCLOUD auth store path, respecting GPUCLOUD_HOME overrides."""
    return get_gpucloud_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`gpucloud tools`, banner/status paint, provider
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from gpucloud_cli.auth import resolve_nous_access_token
