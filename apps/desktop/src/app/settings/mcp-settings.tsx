...
import { getGPUCLOUDConfigRecord, type GPUCLOUDGateway, saveGPUCLOUDConfig } from '@/gpucloud'
...
function getServers(config: GPUCLOUDConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveGPUCLOUDConfig(nextConfig)
