...
const desktopWindow = window as unknown as { gpucloudDesktop?: Window['gpucloudDesktop'] }
const initialGPUCLOUDDesktop = desktopWindow.gpucloudDesktop

function installDesktopBridge(partial: Partial<Window['gpucloudDesktop']> = {}) {
  desktopWindow.gpucloudDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['gpucloudDesktop']
}
...
afterEach(() => {
  ...
  if (initialGPUCLOUDDesktop) {
    desktopWindow.gpucloudDesktop = initialGPUCLOUDDesktop
  } else {
    delete desktopWindow.gpucloudDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['gpucloudDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['gpucloudDesktop']['openExternal'] })
